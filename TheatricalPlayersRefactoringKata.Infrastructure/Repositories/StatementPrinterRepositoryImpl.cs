    ...
    public class StatementPrinterRepositoryImpl : IStatementPrinterRepository {
        ...
        public Result<string> PrintText(Invoice invoice, Dictionary<string, Play> plays, Dictionary<Enum, IGenreStrategy> genres) {
            ...
            foreach (var perf in invoice.Performances) {
                ...
                double thisAmount = 0;
                (thisAmount, totalAmount, volumeCredits) = CalculateAllPerfomances(plays, play, genres, perf, volumeCredits, totalAmount);
        ...
        public Result<string> PrintXml(Invoice invoice, Dictionary<string, Play> plays, Dictionary<Enum, IGenreStrategy> genres) {
            double totalAmount = 0;
            ...
            return Result<string>.Success(IndentXml(xmlDocument));
        }
