...
public class StatementPrinterTests
{
    ...
    public void TestStatementExampleLegacy()
    {
        ...
        StatementPrinter statementPrinter = new StatementPrinter(new TextFormatterAdapter(strategyFactory));
    ...
    public void TestXmlStatementExample()
    {
        ...
        StatementPrinter statementPrinter = new StatementPrinter(new XmlFormatterAdapter(strategyFactory));
        var result = statementPrinter.Print(invoice, plays);
