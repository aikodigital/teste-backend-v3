...
public class StatementPrinterTests
{
    ...
    public void TestXmlStatementExample()
    {
        ...
        plays.Add("as-like", new Play("As You Like It", 2670, "comedy"));
        plays.Add("othello", new Play("Othello", 3560, "tragedy"));
        plays.Add("henry-v", new Play("Henry V", 3227, "historical"));
        plays.Add("john", new Play("King John", 2648, "historical"));
        plays.Add("richard-iii", new Play("Richard III", 3718, "historical"));
        ...
        var result = xmlStatementPrinter.Format(invoice, plays);
